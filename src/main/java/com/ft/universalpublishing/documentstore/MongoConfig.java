...
public class MongoConfig {
  ...
  @JsonProperty private List<String> addresses = new ArrayList<>();

  @JsonProperty @Deprecated private List<String> hosts = new ArrayList<>(3);

  @JsonProperty @Deprecated private String host;
