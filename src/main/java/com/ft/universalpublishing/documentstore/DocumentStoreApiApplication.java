...
import com.ft.universalpublishing.documentstore.service.filter.ContainerRequestLoggingFilter;
import com.ft.universalpublishing.documentstore.service.filter.ContainerResponseLoggingFilter;
import com.ft.universalpublishing.documentstore.service.filter.RequestLoggingFilter;
...
public class DocumentStoreApiApplication extends Application<DocumentStoreApiConfiguration> {
    ...
    public void run(final DocumentStoreApiConfiguration configuration, final Environment environment) {
        ...
        environment.servlets().addFilter("transactionIdFilter", new TransactionIdFilter()).addMappingForUrlPatterns(
        ...
        environment.servlets().addFilter("request-logging-filter", new RequestLoggingFilter())
                .addMappingForUrlPatterns(java.util.EnumSet.allOf(javax.servlet.DispatcherType.class), true, "/*");
        environment.jersey().getResourceConfig().register(ContainerRequestLoggingFilter.class);
        environment.jersey().getResourceConfig().register(ContainerResponseLoggingFilter.class);
    ...
    private void registerResources(DocumentStoreApiConfiguration configuration, Environment environment,
        ...
        collections.put(new Pair<>("complementarycontent", Operation.GET_FILTERED),
                new HandlerChain().addHandlers(extractUuidsHandlers, multipleUuidValidationHandler)
                        .setTarget(findMultipleResourcesByUuidsTarget));
        collections.put(new Pair<>("complementarycontent", Operation.GET_MULTIPLE_FILTERED), new HandlerChain()
                .addHandlers(multipleUuidValidationHandler).setTarget(findMultipleResourcesByUuidsTarget));
        ...
        collections.put(new Pair<>("internalcomponents", Operation.GET_FILTERED),
                new HandlerChain().addHandlers(extractUuidsHandlers, multipleUuidValidationHandler)
                        .setTarget(findMultipleResourcesByUuidsTarget));
        collections.put(new Pair<>("internalcomponents", Operation.GET_MULTIPLE_FILTERED), new HandlerChain()
                .addHandlers(multipleUuidValidationHandler).setTarget(findMultipleResourcesByUuidsTarget));
        ...
        collections.put(new Pair<>("lists", Operation.GET_MULTIPLE_FILTERED), new HandlerChain()
                .addHandlers(multipleUuidValidationHandler).setTarget(findMultipleResourcesByUuidsTarget));
        ...
        collections.put(new Pair<>("generic-lists", Operation.GET_FILTERED),
                new HandlerChain().addHandlers(extractConceptHandler).setTarget(findListByConceptAndType));
        collections.put(new Pair<>("generic-lists", Operation.GET_MULTIPLE_FILTERED), new HandlerChain()
                .addHandlers(multipleUuidValidationHandler).setTarget(findMultipleResourcesByUuidsTarget));
