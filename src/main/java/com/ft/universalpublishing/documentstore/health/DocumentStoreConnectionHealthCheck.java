...
public class DocumentStoreConnectionHealthCheck extends AdvancedHealthCheck {
    private static final String MESSAGE = "Cannot connect to MongoDB";

    private final MongoDocumentStoreService service;
    private final HealthcheckParameters healthcheckParameters;

    public DocumentStoreConnectionHealthCheck(MongoDocumentStoreService service, HealthcheckParameters healthcheckParameters) {
