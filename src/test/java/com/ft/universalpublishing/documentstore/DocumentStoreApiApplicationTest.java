...
public class DocumentStoreApiApplicationTest {
    ...
    private static final DropwizardAppExtension<DocumentStoreApiConfiguration> DW = new DropwizardAppExtension<>(
    ...
    public void shouldRegisterApplicationHealthChecksEvenIfMongoConnectionFails() throws IOException {
        ...
        Response response = client.target(
                String.format("http://localhost:%d/__health", DW.getLocalPort()))
                .request()
                .get();
