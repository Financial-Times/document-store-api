...
public class EmbeddedMongoExtension implements BeforeEachCallback {
  ...
  @Getter private MongoDatabase db;
  ...
  public MongoClient client() {
    ...
    if (mongoTestUrl == null) {
      Assert.fail(
          "System property MONGO_TEST_URL should be set to a valid mongo server instance, e.g. MONGO_TEST_URL=localhost:27017. Alternatively you could skip these tests by providig the -Dshort java program flag");
    }
