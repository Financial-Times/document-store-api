...
public class PublicConcordancesApiServiceImplTest {
  private PublicConcordancesApiClient publicConcordancesApiClientMock =
      mock(PublicConcordancesApiClient.class);
  private PublicConcordancesApiServiceImpl publicConcordancesApiService =
      new PublicConcordancesApiServiceImpl(publicConcordancesApiClientMock);
  ...
  public void shouldSearchConcepts() throws JsonProcessingException {
    ...
    Identifier identifier3 =
        new Identifier("http://api.ft.com/system/SMARTLOGIC", UUID.randomUUID().toString());
    ...
    Concordances concordances =
        new Concordances(Arrays.asList(concordance, concordance2, concordance3));
